<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Criar.aspx.cs" Inherits="ControleGames.Criar" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Criar Game</title>
...
<body>
    <div class="well">
        <div class="container">
            <h1>
                <i class="fa fa-gamepad"></i>&nbsp;Games <i class="fa fa-angle-right"></i>&nbsp;<small><i class="fa fa-plus"></i>&nbsp;Criar</small>
            </h1>
        </div>
    </div>
    <div class="container">
